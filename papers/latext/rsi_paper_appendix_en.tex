...
\textbf{Supplementary Material}\\[0.4em]
\large\textit{Appendices A, B, C}
}
...
\noindent This document contains supplementary material for the paper
\emph{Rule-State Inference (RSI): A Bayesian Framework for Compliance
Monitoring in Rule-Governed Domains}. It includes the dataset
dictionary (Appendix~A), complete theorem proofs (Appendix~B), and
reproducibility details (Appendix~C).
